var game = new Phaser.Game(800, 600, Phaser.CANVAS, "", {preload: onPreload, create: onCreate, update: onUpdate});                
	...
	function onPreload() {
		game.load.image("team1", "../img/mars_04.png");
        game.load.image("hexagon", '../img/sand_03.png');
        game.load.image("team2", "../img/stone_04.png");
        game.load.image("marker", "../img/sand_05.png");
	}
	     ...
	     for(var i = 0; i < gridSizeY/2; i ++){
			...
			for(var j = 0; j < gridSizeX; j ++){
				if(gridSizeY%2==0 || i+1<gridSizeY/2 || j%2==0){
                    ...
                    if(j <= 5) { 
                        var hexagon = game.add.sprite(hexagonX, hexagonY, "team1");
                    } else {
                        if(j >= 27) {
                            var hexagon = game.add.sprite(hexagonX, hexagonY, "team2");
                        }
                        else{	
